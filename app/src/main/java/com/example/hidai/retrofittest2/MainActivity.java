    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            getSupportFragmentManager()
                    .beginTransaction()
                    .add(R.id.frame_container, new TempExamFragment())
                    .commit();
        }
        ...
        final EditText bLogin = (EditText) findViewById(R.id.txtLogin);
        final EditText bPassword = (EditText) findViewById(R.id.txtPassword);

        Button asincrono2 = (Button) findViewById(R.id.button2);
